...
Test test_a1_task1_local_to_world("a1.task1.local_to_world", []() {
	...
	// Test::print_matrix(hierarchy.A->local_to_parent() * 
	// hierarchy.B->local_to_parent() * hierarchy.C->local_to_parent());
...
Test test_a1_task1_world_to_local("a1.task1.world_to_local", []() {
	...
	// Test::print_matrix(hierarchy.C->parent_to_local() * 
	// hierarchy.B->parent_to_local() * hierarchy.A->parent_to_local());
