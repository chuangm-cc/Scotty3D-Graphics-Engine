...
Test test_a2_l2_split_edge_bound_triangle1("a2.l2.split_edge.bound_triangle", []() {
	Halfedge_Mesh mesh = Halfedge_Mesh::from_indexed_faces({
...
Test test_a2_l2_split_triangle2("a2.l2.split_edge.triangle2", []() {
	Halfedge_Mesh mesh = Halfedge_Mesh::from_indexed_faces({
		Vec3(0.0f,1.0f,0.0f), Vec3(-1.0f, 0.0f, 0.0f),
...
Test test_a2_l2_split_triangle3("a2.l2.split_edge.triangle3", []() {
	Halfedge_Mesh mesh = Halfedge_Mesh::from_indexed_faces({
	...
	Halfedge_Mesh::EdgeRef edge = mesh.halfedges.begin()->next->twin->edge;
	// 
...
Test test_a2_l2_split_triangle4("a2.l2.split_edge.triangle4", []() {
	Halfedge_Mesh mesh = Halfedge_Mesh::from_indexed_faces({
		Vec3(-1.0f,1.0f,0.0f), Vec3(1.0f, 1.0f, 0.0f), Vec3(1.0f, 0.0f, 0.0f),
		Vec3(1.0f, -1.0f, 0.0f)
	}, {
		{0,1,2},{0,2,3}
	});
