...
struct Pipeline {
	...
	static float cross_product_2d(Vec3 a,Vec3 b);
	static bool check_inside(Vec3 a,Vec3 b,Vec3 c, Vec3 q);
	static bool check_inside_and_ratio(Vec3 a,Vec3 b,Vec3 c, Vec3 q,
	float& wa,float& wb,float& wc);
	static void get_ratio_outOfRange(Vec3 a,Vec3 b,Vec3 c, Vec3 q,
	float& wa,float& wb,float& wc);
	static bool check_point_intersect(Vec3 A, Vec3 B, Vec3 C);
	static bool check_line_intersect(Vec3 A, Vec3 B, Vec3 C, Vec3 D);
	static bool check_on_edge_top_left(Vec3 a,Vec3 b,Vec3 c, Vec3 q,float min_x,float max_y); 
};
