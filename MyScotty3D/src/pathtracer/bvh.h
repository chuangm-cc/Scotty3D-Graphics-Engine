...
public:
	...
	void recursion(size_t max_leaf_size, size_t node_idx);

	

	// void iteration_axis(size_t start_idx,size_t size,
	// std::vector<Primitive>::iterator it_start,std::vector<Primitive>::iterator it_end);
	...
	void hit_recursion(const Ray& ray, size_t node_idx,Trace &ret) const;
